...
/datum/trait/negative/boneless
	...
	var/limb_health = 1
	excludes = list(/datum/trait/negative/hollow,/datum/trait/negative/boneless/major,/datum/trait/positive/densebones)
...
/datum/trait/negative/boneless/major
	...
	limb_health = 0.5
	excludes = list(/datum/trait/negative/hollow,/datum/trait/negative/boneless,/datum/trait/positive/densebones)
